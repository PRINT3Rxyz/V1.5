...
contract FaucetToken is IERC20 {
     ...
     * construction.
     */
    constructor(string memory name, string memory symbol, uint8 decimals, uint256 dropletAmount) {
        _name = name;
        _symbol = symbol;
        _decimals = decimals;
        _gov = msg.sender;
    ...
    function claimDroplet() public {
        ...
        require(_claimedAt[msg.sender] + DROPLET_INTERVAL <= block.timestamp, "FaucetToken: droplet not available yet");
